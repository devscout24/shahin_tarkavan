            ...
            <div class="modal-body">
                <form id="sport-option-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="baner_title" id="title" class="form-control" placeholder="Football (Soccer)" required>
                    </div>
                    <div class="mb-3">
                        <label for="image" class="form-label">Baner Image</label>
                        <input type="file" name="banner_image" id="banner" class="form-control" required>
