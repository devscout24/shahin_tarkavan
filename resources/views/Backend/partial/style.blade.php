 <head>
    ...
    <link rel="stylesheet" href="{{asset('property/assets/vendor/css/core.css')}}" />
    <link rel="stylesheet" href="{{asset('property/assets/css/demo.css')}}" />
    ...
    <link rel="stylesheet" href="{{ $assetPath }}/assets/vendor/libs/apex-charts/apex-charts.css" />
